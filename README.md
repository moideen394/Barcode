...
<body>
    ...
    <div id="scanner-container" style="opacity: 0.5;background: #131311a8;">
        <div style="width: 200px; height: 250px; opacity:0; position: absolute;bottom: 70px;border: 2px solid red;"></div>
    <div style="position: absolute;bottom: 50px;"><span>Test file</span></div>
    </div>
